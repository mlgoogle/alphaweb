...
class Helper
{
     ...
     *
     * @param $string 输入字符
     * @param int|条件 $param 条件
     * @param string|类型 $type 类型
     * selected checked
     * @return string
     */
     ...
     * @param $_string
     * @return string
     * @internal param array|object $_date
     */
    static public function htmlString($_string)
    {
        if (is_array($_string)) {
     ...
     * @param int $start
     * @return string
     * @internal param int $slen 截取的长度
     * @internal param int $startdd 开始标记处
     */
     ...
     * @param $filetype
     * @internal param string $filetype文件类型 (.jpg/.gif/.png)
     */

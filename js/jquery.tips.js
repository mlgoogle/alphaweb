...
(function($) {
    $.fn.tips = function(options) {
        ...
        if (!$('#jquery_tips_style').length) {
            ...
            style += '.jq_tips_info{word-wrap: break-word;word-break:normal;padding: 6px 8px;border-radius:4px;max-width:300px;overflow:hidden;box-shadow:1px 1px 1px #999;border: 1px solid #eee;font-size:12px;cursor:pointer;}';
            style += '</style>';
